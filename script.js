...
startBtn.parentNode.insertBefore(usernameInput, startBtn);
...
startBtn.onclick = () => {
    ...
    if (!username) {
        ...
        errorMsg.style.animation = 'slideDown 0.5s ease';
        return
    }
    errorMsg.innerText = '';
...
function showResultBox() {
    ...
    scoreText.textContent = `Dear ${username} Your Score is ${userScore} out of ${questions.length}`;
